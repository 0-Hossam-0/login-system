    ...
    <div className="ml-10 mt-[30px] transition-all duration-200 translate-x-[-540px] invisible" ref={registerLevel.firstInputs} id="first-inputs">
      <div className="flex gap-[60px]">
        <div className="flex flex-col gap-2 mb-5">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300 ml-2">Username</label>
        ...
        <div className="flex flex-col gap-2 mb-5">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300 ml-2">Email</label>
          <input type="email" className="w-[220px] rounded-md p-1 pl-2 focus:outline-indigo-500 bg-[#d5d4d4] hover:bg-[#d8d7d7] outline-none border-black border" placeholder="Email" ref={RegisterInputs.email} />
      ...
      <div className="flex gap-[60px]">
        ...
        <div className="flex flex-col gap-2 mb-5 ">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300 ml-2">Confirm Password</label>
          <input type="password" className="w-[220px] rounded-md p-1 pl-2 focus:outline-indigo-500 bg-[#d5d4d4] hover:bg-[#d8d7d7] outline-none border-black border" placeholder="Confirm Password" ref={RegisterInputs.rPassword} />
