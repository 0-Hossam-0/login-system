    ...
    <div className="ml-10 mt-[30px] transition-all duration-200 translate-x-[-530px]" ref={registerLevel.secondInputs}>
      <div className="flex gap-[60px]">
        <div className="flex flex-col gap-2 mb-5">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300 ml-2">First Name</label>
        ...
        <div className="flex flex-col gap-2 mb-5">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300 ml-2">Last Name</label>
          <input type="text" className="w-[220px] rounded-md p-1 pl-2 focus:outline-indigo-500 bg-[#d5d4d4] hover:bg-[#d8d7d7] outline-none border-black border" placeholder="Last Name" ref={RegisterInputs.secondName} />
          <p className="ml-[10px] text-red-500 font-bold " ref={RegisterMessages.secondName}></p>
        </div>
      </div>
      <div className="flex gap-[60px]">
        <div className="flex flex-col gap- mb-5">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300 ml-2">Phone Number</label>
          <input type="tel" className="w-[220px] rounded-md p-1 pl-2 focus:outline-indigo-500 bg-[#d5d4d4] hover:bg-[#d8d7d7] outline-none border-black border" placeholder="Phone Number" ref={RegisterInputs.phone} />
          <p className="ml-[20px] mt-3 text-red-500 font-bold" ref={RegisterMessages.phone}></p>
        </div>
        <div className="flex flex-col gap-2 mb-5">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-300 ml-2">Gender</label>
