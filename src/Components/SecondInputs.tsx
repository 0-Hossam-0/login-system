    ...
    <div className="ml-10 mt-[30px] transition-all duration-200 translate-x-[-530px]" ref={registerLevel.secondInputs}>
      <div className="flex gap-[60px]">
        <div className="flex flex-col gap-2 mb-5">
          <input type="text" className="w-[220px] rounded-md p-1 pl-2 focus:outline-indigo-500 bg-[#d5d4d4] hover:bg-[#d8d7d7] outline-none border-black border" placeholder="Enter your first name" ref={RegisterInputs.firstName} />
          <p className="ml-[20px] text-red-500 font-bold" ref={RegisterMessages.firstName}></p>
        </div>
        <div className="flex flex-col gap-2 mb-5">
          <input type="text" className="w-[220px] rounded-md p-1 pl-2 focus:outline-indigo-500 bg-[#d5d4d4] hover:bg-[#d8d7d7] outline-none border-black border" placeholder="Enter your last name" ref={RegisterInputs.secondName} />
          <p className="ml-[10px] text-red-500 font-bold " ref={RegisterMessages.secondName}></p>
        </div>
      </div>
      <div className="flex gap-[60px]">
        <div className="flex flex-col gap- mb-5">
          <input type="tel" className="w-[220px] rounded-md p-1 pl-2 focus:outline-indigo-500 bg-[#d5d4d4] hover:bg-[#d8d7d7] outline-none border-black border" placeholder="Enter your phone number" ref={RegisterInputs.phone} />
