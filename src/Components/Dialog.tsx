    ...
    showAddLayout && (
      <>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
          <div className="bg-slate-100 dark:bg-[#454849] rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-gray-300 dark:border-gray-600">
              ...
              <button
                ...
                className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
              >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 rounded-xl border border-gray-300 dark:border-gray-500 focus:border-[#6366f1] focus:ring-2 focus:ring-[#6366f1]/20 outline-none transition-all"
                ...
                {showAddLoadingState && (
                  <div className="flex items-center justify-center py-2">
                    <FontAwesomeIcon icon={faSpinner} className="animate-spin text-[#6366f1] mr-2" />
            ...
            {/* Footer */}
            <div className="flex gap-3 p-6 border-t border-gray-300 dark:border-gray-600">
              <button 
                className="flex-1 px-4 py-3 text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 rounded-xl font-medium transition-colors"
                onClick={() => setShowAddLayout(false)}
              >
                Cancel
              </button>
              <button
                className="flex-1 px-4 py-3 bg-[#6366f1] hover:bg-[#5855eb] text-white rounded-xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
