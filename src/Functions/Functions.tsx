import type { HandleInputsLevelProps, HandleOpeningErrorProps, ResetRegisterPanelProps, SendCodeProps } from '../Types/Interfaces';
import type { SwitchPanelsProps } from '../Types/Interfaces';
